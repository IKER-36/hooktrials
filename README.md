...
[![Release](https://img.shields.io/badge/release-v0.33.5-6366f1?style=flat-square)](docs/release-status.md)
...
Current public release: **v0.33.5** (1 August 2026). The managed sandbox is available at
...
./hooktrials logs
./hooktrials backup
./hooktrials update --release v0.33.5 --check
./hooktrials update --release v0.33.5
```
...
The current `v0.33.5` interface keeps real delivery work in **Product** and deterministic
