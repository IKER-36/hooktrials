...
[![Release](https://img.shields.io/badge/release-v0.27.0-6366f1?style=flat-square)](docs/release-status.md)
...
Current public release: **v0.27.0** (1 August 2026). The managed sandbox is available at
...
The current `v0.27.0` interface keeps real delivery work in **Product** and deterministic
