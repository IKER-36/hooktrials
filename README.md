...
[![Release](https://img.shields.io/badge/release-v0.21.0-6366f1?style=flat-square)](docs/release-status.md)
...
Current public release: **v0.21.0** (30 July 2026). The managed sandbox is available at
...
./hooktrials logs
./hooktrials backup
./hooktrials update --release v0.21.0
```
...
The current `v0.21.0` interface keeps real delivery work in **Product** and deterministic
