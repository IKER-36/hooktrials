...
[![Release](https://img.shields.io/badge/release-v0.13.0-6366f1?style=flat-square)](docs/release-status.md)
...
Current public release: **v0.13.0** (28 July 2026). The managed sandbox is available at
...
The current `v0.13.0` interface keeps real delivery work in **Product** and deterministic
