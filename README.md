...
[![Release](https://img.shields.io/badge/release-v0.23.0-6366f1?style=flat-square)](docs/release-status.md)
...
Current public release: **v0.23.0** (31 July 2026). The managed sandbox is available at
...
./hooktrials logs
./hooktrials backup
./hooktrials update --release v0.23.0
```
...
The current `v0.23.0` interface keeps real delivery work in **Product** and deterministic
