...
[![Release](https://img.shields.io/badge/release-v0.15.1-6366f1?style=flat-square)](docs/release-status.md)
...
Current public release: **v0.15.1** (28 July 2026). The managed sandbox is available at
...
./hooktrials logs
./hooktrials backup
./hooktrials update --release v0.15.1
```
