...
const steps = [
  ...
  },
  {
    ...
    body: 'Webhook Hub creates the public provider URL, encrypted destination, validation and Observe or Protect delivery strategy as one live connection.',
    path: '/app/live-webhooks',
    target: 'live-webhooks',
    selector: '.ht-live-grid',
    note: 'Live connections stay in Product and never appear inside the synthetic Trial inventory.',
  },
  {
  ...
  {
    eyebrow: '05 / TRIAL ENDPOINTS',
    title: 'Build a deterministic trial',
    body: 'Trial endpoints receive synthetic traffic and return controlled failures without forwarding requests into your real delivery path.',
    path: '/app/endpoints',
    target: 'endpoints',
