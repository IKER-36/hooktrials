...
export const es: Record<string, string> = {
  ...
  'Explain what happened, prove recovery and share a redacted record safely.':
    'Explica qué ocurrió, demuestra la recuperación y comparte un registro redactado de forma segura.',
  'Refresh reports': 'Actualizar informes',
  'The last known reports remain visible.': 'Los últimos informes conocidos siguen visibles.',
  'Evidence unavailable': 'Evidencias no disponibles',
  'Reports could not load.': 'No se pudieron cargar los informes.',
  'Loading reports': 'Cargando informes',
  'No evidence reports yet.': 'Todavía no hay informes de evidencia.',
  'Run a Trial or send a live event. HookTrials will generate a redacted report after the delivery chain is recorded.':
    'Ejecuta una prueba Trial o envía un evento real. HookTrials generará un informe redactado cuando se registre la cadena de entrega.',
  'Open Control Center': 'Abrir Centro de control',
  'Evidence summary': 'Resumen de evidencias',
  Reports: 'Informes',
  Passed: 'Superado',
  'Needs review': 'Requiere revisión',
  'Recovery proven': 'Recuperación demostrada',
  'RECORDED EVENTS': 'EVENTOS REGISTRADOS',
  'Evidence timeline': 'Línea temporal de evidencias',
  'Search reports': 'Buscar informes',
  'Search by route or event': 'Buscar por ruta o evento',
  'Filter by endpoint': 'Filtrar por endpoint',
  'All routes': 'Todas las rutas',
  All: 'Todas',
  Review: 'Revisión',
  Pending: 'Pendiente',
  'Report status': 'Estado del informe',
  'No reports match this view.': 'Ningún informe coincide con esta vista.',
  'Clear a filter or search for another event.': 'Quita un filtro o busca otro evento.',
  'Show all reports': 'Mostrar todos los informes',
  attempts: 'intentos',
  deliveries: 'entregas',
  'Selected evidence report': 'Informe de evidencia seleccionado',
  'EXPLAINABLE REPORT': 'INFORME EXPLICABLE',
  'Open route control': 'Abrir control de ruta',
  'Resilience score': 'Puntuación de resiliencia',
  Outcome: 'Resultado',
  Recorded: 'Registrado',
  'RECOVERY READOUT': 'LECTURA DE RECUPERACIÓN',
  'Impact and recovery': 'Impacto y recuperación',
  Impact: 'Impacto',
  Duration: 'Duración',
  'Evidence chain': 'Cadena de evidencia',
  'RECOVERY TIMELINE': 'LÍNEA TEMPORAL DE RECUPERACIÓN',
  'What happened': 'Qué ocurrió',
  'SAFE HANDOFF': 'ENTREGA SEGURA',
  'Share redacted evidence': 'Compartir evidencia redactada',
  'Create a temporary link with no payloads, secrets, credentials or destination URLs.':
    'Crea un enlace temporal sin payloads, secretos, credenciales ni URLs de destino.',
  'Copy link': 'Copiar enlace',
  'Create 24h link': 'Crear enlace de 24 h',
  'A share link is already active for this report.': 'Ya hay un enlace activo para este informe.',
  'Action required': 'Acción necesaria',
  'Delivery protected': 'Entrega protegida',
  Delivered: 'Entregado',
  Received: 'Recibido',
  'Creating…': 'Creando…',
  Copied: 'Copiado',
  ...
  'Type to search routes and actions…': 'Escribe para buscar rutas y acciones…',
  'No commands match your search.': 'Ningún comando coincide con la búsqueda.',
  'Navigate the workspace': 'Navega por el espacio de trabajo',
  Navigate: 'Navegar',
  Select: 'Seleccionar',
  'Account settings': 'Configuración de la cuenta',
  'Profile, password, email and API keys': 'Perfil, contraseña, correo y claves API',
  Account: 'Cuenta',
  Actions: 'Acciones',
  'Use light mode': 'Usar modo claro',
  'Use dark mode': 'Usar modo oscuro',
  'Switch the workspace appearance': 'Cambia la apariencia del espacio de trabajo',
  'Review the complete HookTrials workflow': 'Revisa el flujo completo de HookTrials',
  'Refresh workspace': 'Actualizar espacio de trabajo',
  'Reload routes, scenarios and current limits': 'Recarga rutas, escenarios y límites actuales',
  'Change the navigation density': 'Cambia la densidad de navegación',
