...
- [Audit history via Incidents & recovery](audit-history.md)
...
| [Isolated Demo Lab](demo-lab.md)                           | Optional synthetic end-to-end learning environment |
...
| [Scenarios](scenario-studio.md)                            | Custom response-sequence authoring                 |
...
| [Audit history via Incidents & recovery](audit-history.md) | Redacted operational change record                 |
