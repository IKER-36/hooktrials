...
Open a protected route in **Integrations**, expand **Route control** and switch **Outbound delivery**
...
continues the configured retry policy. Use Incidents & recovery and the event inspector to follow every
delivery state.
