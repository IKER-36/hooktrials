...
The current tagged release is `v0.23.0`. Self-hosted Compose intentionally builds the checked-out
...
`v0.18.2`, and so on). A minor release such as `v0.23.0` is reserved for a substantial new,
